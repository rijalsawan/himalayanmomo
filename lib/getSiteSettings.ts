...
const defaultSettings: SiteSettings = {
  ...
  contactEmail: 'himalayan.momostation@gmail.com',
  contactAddressStreet: '500 Portage Avenue',
  contactAddressCity: 'Winnipeg',
  contactAddressState: 'MB',
  contactAddressZip: 'R3C 1X5',
