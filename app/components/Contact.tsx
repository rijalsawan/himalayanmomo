                ...
                >
                  {item.href ? (
                    <a
                      ...
                      className=" flex p-3 space-x-3 border-[3px] border-warm-light/15 bg-warm-light/[0.04] hover:bg-warm-light/[0.07] hover:border-golden/40 transition-colors duration-300"
                    >
